...
const generateAccessAndRefreshToken = async(userId) => { // we will not use asyncHandler here as we are not mmaking any web request just a internal method
    try {
...
const logoutUser = asyncHandler(async(req, res) =>{
    ...
    await User.findByIdAndUpdate(
        req.user._id,
        {
            $set:{ // this mongodb operator can update the value of a particular feild
                refreshToken: undefined
            }
        },
        {
            new: true // retur value will have the updated value
        }
    )
